...
export default function HistoricalAnalyzer() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="mt-4 sm:mt-6 lg:mt-8 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
                <div className='text-center'>
                    <h1 className='text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-800 mb-4'>
                        This is my <span className='text-green-700 capitalize'>historical analyzer!</span>
                    </h1>
                    <p className="text-lg sm:text-xl lg:text-2xl text-gray-800 font-semibold max-w-3xl mx-auto mb-4">
