...
export default function Portfolio() {
  ...
  return (
    <div className='portfolio-container max-w-2xl mx-auto py-8 px-4'>
      ...
      <div className="mb-10 flex flex-col items-start gap-3 bg-white rounded-lg shadow p-5 sm:p-8">
        ...
        <p className="text-base sm:text-lg mb-2 text-gray-700 text-left w-full">
          ...
          This app is not connected to any backend, with a single exception that a simple API call made to fetch a random "Fact of the Day".<br />
        </p>
        <DownloadButton
          url={sudokuUrl}
